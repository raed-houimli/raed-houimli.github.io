...
export const personalInfo = {
  ...
  tagline: 'Full-stack engineer turned DevOps specialist – architecting enterprise infrastructure from development through production deployment with AWS, Kubernetes, and CI/CD automation.',
...
export const experiences: Experience[] = [
  {
    ...
    highlights: [
      ...
      'Implementing CI/CD pipelines with GitHub Actions/GitLab CI reducing deployment time by 60-70%',
      'Designing and managing production Kubernetes clusters on EKS with auto-scaling and cost optimization',
      'Building reusable Terraform modules for multi-environment AWS infrastructure provisioning',
  ...
  },
  {
    ...
    highlights: [
      ...
      'Built end-to-end CI/CD pipelines reducing deployment time by 70% (from hours to minutes)',
      'Containerized 20+ legacy applications with Docker, reducing deployment issues by 85%',
      'Implemented production Kubernetes cluster on EKS with auto-scaling, achieving 40% cost reduction',
      'Established comprehensive monitoring stack (Prometheus, Grafana, CloudWatch) for real-time observability',
      'Automated disaster recovery processes achieving RPO of 1 hour and RTO of 30 minutes',
      'Led security hardening initiatives reducing security incidents by 90% through secrets management',
      'Enabled 50+ daily deployments through GitOps practices with ArgoCD',
    ],
    technologies: [
      'AWS',
      'Terraform',
  ...
  },
  {
    ...
    highlights: [
      ...
      'Reduced database query latency by 60% through PostgreSQL optimization and strategic indexing',
      'Implemented comprehensive REST APIs with JWT authentication, rate limiting, and OpenAPI documentation',
      'Decreased deployment time by 87% (from 2 hours to 15 minutes) through Docker containerization',
      'Led code reviews implementing SOLID principles and design patterns, achieving 95%+ test coverage',
      'Mentored 2 junior engineers on backend architecture, system design, and development best practices',
      'Integrated Redis caching layer improving API response times by 40%',
    ],
    technologies: [
      'Python',
      'FastAPI',
