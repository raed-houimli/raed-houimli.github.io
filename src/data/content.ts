...
export const about = {
  summary: `Expertise in AWS, Kubernetes, CI/CD automation, and infrastructure-as-code with proven track record of optimizing deployment pipelines and ensuring high-availability systems.`,
};
