...
export const experiences: Experience[] = [
  {
    ...
    highlights: [
      ...
      'Designing and managing Kubernetes clusters on EKS with auto-scaling and cost optimization',
    ...
    technologies: [
      'AWS (EC2, ECS, EKS, S3, RDS, Lambda, VPC, IAM)',
      'Terraform',
      'Kubernetes',
      'Docker',
      'GitHub Actions',
  ...
  },
  {
    ...
    highlights: [
      ...
      'Built end-to-end CI/CD pipelines reducing deployment time from hours to minutes (70% improvement)',
      ...
      'Automated disaster recovery processes with RPO of 1 hour and RTO of 30 minutes',
      'Led security hardening initiatives reducing incidents by 90% through secrets management and scanning',
  ...
  },
  {
    ...
    highlights: [
      ...
      'Implemented comprehensive REST APIs with authentication, rate limiting, and API documentation',
      'Decreased deployment time from 2 hours to 15 minutes through Docker containerization and CI/CD',
      'Led code reviews and established SOLID principles, achieving 95%+ test coverage',
      'Mentored 2 junior engineers on backend architecture, system design, and best practices',
      'Integrated Redis caching layer improving response times by 40%',
    ],
    technologies: [
      'Python',
      'FastAPI',
